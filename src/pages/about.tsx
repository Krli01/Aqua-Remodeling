      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-20">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-(--color-bg-dark)">
            ...
            <ul className="space-y-3 text-[rgb(100,98,92)]">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm">{t("about.values.quality.text")}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="shrink-0 w-5 h-5 rounded-full bg-(--color-primary)/20 flex items-center justify-center text-(--color-primary) text-xs font-bold">
                ...
                <div>
                  <p className="font-medium">
                    {t("about.values.customer_satisfaction.title")}
                  </p>
                  <p className="text-sm">
                    {t("about.values.customer_satisfaction.text")}
                  </p>
                </div>
              </li>
            </ul>
